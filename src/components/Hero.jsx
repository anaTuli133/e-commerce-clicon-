...
export default function Hero({ slides = [] }) {
  ...
  if (!slides.length) return <div className="h-96 bg-gray-100 animate-pulse rounded" />;
  const slide = slides[active];

  return (
    <div className="relative bg-gray-50 rounded-md overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] items-center gap-6 p-8 md:p-12 min-h-[320px]">
        <div>
