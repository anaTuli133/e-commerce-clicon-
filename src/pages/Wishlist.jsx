              ...
              <div key={product.id} className="grid grid-cols-1 md:grid-cols-[1fr_120px_120px_140px] items-center gap-3 px-5 py-4 border-b border-gray-50 last:border-0">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="bg-brand-orange hover:bg-brand-orange-dark disabled:bg-gray-200 disabled:cursor-not-allowed text-white text-xs font-semibold px-3 py-2 rounded flex items-center gap-1.5"
                  >
                    Add to Cart 🛒
                  </button>
