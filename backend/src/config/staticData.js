// backend/public এর ছবিগুলো serve করার জন্য base URL — অবশ্যই .env এর PORT
// এর সাথে মিলতে হবে, নাহলে কোনো ছবিই লোড হবে না।
const IMAGE_BASE_URL = process.env.IMAGE_BASE_URL || "http://localhost:5000";
const categoryImg = (filename) => `${IMAGE_BASE_URL}/categories/${filename}`;

export const categories = [
  { id: "computer-laptop", name: "Computer & Laptop", icon: "laptop", image: categoryImg("computer-laptop.png") },
  { id: "smartphone", name: "SmartPhone", icon: "smartphone", image: categoryImg("smartphone.png") },
  { id: "headphone", name: "Headphones", icon: "headphones", image: categoryImg("headphones.png") },
  { id: "accessories", name: "Accessories", icon: "keyboard", image: categoryImg("accessories.png") },
  { id: "camera-photo", name: "Camera & Photo", icon: "camera", image: categoryImg("camera-photo.png") },
  { id: "tv-homes", name: "TV & Homes", icon: "tv", image: categoryImg("tv-homes.png") },
];
...
// express.static("/hero", ...) route দিয়ে serve হয়।
